...
4. **Bridge** — surviving postings are appended to [career-ops](https://github.com/career-ops-hq/career-ops)'s `data/pipeline.md` queue. Second dedup pass against scan-history, pipeline.md, and `company::role` pairs in applications.md.
...
Note: this repository contains only the orchestrator. [JobSpy](https://github.com/speedyapply/JobSpy) (MIT) and [career-ops](https://github.com/career-ops-hq/career-ops) (MIT) are fetched at setup time as separate works under their own licenses.
