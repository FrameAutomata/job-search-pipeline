...
_WINERROR_HINTS = {
    ...
    206:  "ERROR_FILENAME_EXCED_RANGE — the full command line is too long (Windows caps argv ~32K direct / ~8K via cmd). A large argument value (e.g. a base64'd file passed via -f) is overflowing argv; pipe it through a temp file or stdin.",
