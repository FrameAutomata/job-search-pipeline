...
function renderReview() {
  ...
  const lines = [
    ...
    `Work auth:     ${[f.citizenship, f.requires_sponsorship === "yes" ? "needs sponsorship" : "no sponsorship needed", f.work_auth_regions && `auth: ${f.work_auth_regions}`].filter(Boolean).join(" · ") || "(defaults)"}`,
